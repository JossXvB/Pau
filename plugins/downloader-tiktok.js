...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: '𝐉𝐨𝐬𝐬 𝐁𝐨𝐭 🤺', body: null, thumbnail: imagen1, sourceUrl: 'https://instagram.com/paulina.storee/'}, mentionedJid: [m.sender]}}}, aa);
