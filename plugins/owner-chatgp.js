...
const handler = async (m, {conn, text, groupMetadata}) => {
  ...
  const fakegif = {key: {participant: `0@s.whatsapp.net`, ...('6289643739077-1613049930@g.us' ? {remoteJid: '6289643739077-1613049930@g.us'} : {})}, message: {'videoMessage': {'title': '𝒋𝒐𝒔𝒔 𝒃𝒐𝒕  🤺- MD🍁⃨፝⃕✰', 'h': `Hmm`, 'seconds': '99999', 'gifPlayback': 'true', 'caption': '𝒋𝒐𝒔𝒔 𝒃𝒐𝒕  🤺', 'jpegThumbnail': false}}};
